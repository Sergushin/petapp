import { Box, Button, Center, Collapse, Divider, Fade, Flex, Heading, Input, InputGroup, InputLeftElement, Tab, TabList, Tabs, Text, useDisclosure } from "@chakra-ui/react";
...
const Header = () => {
    ...
    return (
        <Box bgColor={'white'} pos={'fixed'} maxW={'425px'} w={'100%'} px={5}  zIndex={10}>
            ...
            <Button onClick={onToggle} float={'right'}  w={'50px'} h={'50px'} borderRadius={'50%'} bgColor="transparent" >
